...
const EditEventModal = (props) => {
    ...
    let selectDate = startTimeCheck ? startTime : endTime;
    ...
    return (
        <Block flex style={styles.container}>
            ...
            <Block>
                ...
                <TouchableOpacity style={styles.dateTime} onPress={() => { setDateTimeModalVisible(!dateTimeModal) }} >
            ...
            <Block style={[{ paddingTop: '5%' }, { marginTop: 10 }]}>
                <TouchableOpacity style={styles.dateTime} onPress={() => { setNotifyModalVisible(!notifyModal) }}>
                ...
                <TouchableOpacity style={styles.dateTime} onPress={() => { setRepeatModalVisible(!repeatModal) }}>
                    <Block style={styles.note}>
            ...
            <Block style={styles.buttonContainer}>
                <Button style={styles.button} onPress={props.closeModal} textStyle={styles.buttonText} shadowless onPress={() => { props.closeModal() }}>취소</Button>
                <Button style={styles.button} textStyle={styles.buttonText} shadowless onPress={() => { props.navigation.goBack(); props.closeModal(); }}>저장</Button>
            </Block>
        </Block>
    );
}
